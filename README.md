...
- [Read the documentation in English](README.en.md)
- [Leia a documentação em Português do Brasil](README.pt-BR.md)
...
- [README em PT-BR](README.pt-BR.md)
- [Contribution guide](CONTRIBUTING.md)
- [Code of Conduct](CODE_OF_CONDUCT.md)
- [Support](SUPPORT.md)
- [Security policy](SECURITY.md)
- [Showcase and product phases](SHOWCASE.md)
...
The public repository is available at [matheusassuncaoo/logline](https://github.com/matheusassuncaoo/logline). Repository-specific badges can be added when release automation is available.

O repositório público está disponível em [matheusassuncaoo/logline](https://github.com/matheusassuncaoo/logline). Badges específicos do repositório podem ser adicionados quando houver automação de releases.
